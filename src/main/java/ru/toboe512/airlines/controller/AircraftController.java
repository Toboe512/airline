...
public interface AircraftController {
    ...
    */
    ...
    ResponseEntity<HttpStatus> createAircraft(@RequestBody AircraftDto aircraftDto);
    ...
    @ApiResponse(responseCode = "404", description = "Page not found")
    ResponseEntity<HttpStatus> updateAircraft(@RequestBody AircraftDto aircraftDto);
